<template>
  <div>
    ...
    >
      <a-form-item label="Имя" v-if="editableData[editingKey]">
        <a-input
            v-model:value="editableData[editingKey].name"
            :disabled="!isEditing"
        />
      </a-form-item>
      <a-form-item label="Возраст" v-if="editableData[editingKey]">
        <a-input-number
      ...
      <a-form-item label="Адрес" v-if="editableData[editingKey]">
        <a-select
      ...
      <a-form-item v-if="editableData[editingKey]">
        <a-checkbox
...
const skeletonDataSource = ref(skeletonData);
